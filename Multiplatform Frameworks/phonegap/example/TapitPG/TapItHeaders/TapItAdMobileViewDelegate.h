...
@protocol TapItAdMobileViewDelegate <NSObject>
@optional
...
/** The TapItAdMobileInterstitialViewDelegate protocol defines methods that a delegate of a TapItAdMobileInterstitialView object can optionally implement to receive notifications from ad. */
@protocol TapItAdMobileInterstitialViewDelegate <TapItAdMobileViewDelegate>
@optional
